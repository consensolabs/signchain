...
export default function Share(props) {
  ...
  const uploadFile = async () => {
    ...
    const receipt = await index.uploadFile(
      partiesInvolved,
      file,
      password,
      setSubmitting,
  ...
  return (
    <Grid
      textAlign="center"
      style={{ height: "20vh", padding: "10vh", justifyContent: "center" }}
    ...
    >
      <Grid.Column style={{ maxWidth: 300 }}>
        ...
        <Button loading={submitting} positive style={{ margin: "4rem" }} onClick={uploadFile}>
          Share file
        </Button>
      </Grid.Column>
    </Grid>
